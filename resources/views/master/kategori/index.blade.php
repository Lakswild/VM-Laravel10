    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <a href="{{ route('kategori.add') }}" class="btn btn-xs btn-primary" style="margin-left: 1.25rem; margin-top: 1.25rem;">Add</a>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableLevel">
                            ...
                            <tbody>
                                <tr class="odd gradeX">
                                    ...
                                    <td>Test</td>
                                    <td class="center">
                                        <a href="{{ route('kategori.edit') }}"class="btn btn-xs btn-warning">Edit</a>
